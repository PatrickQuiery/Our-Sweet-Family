 ...
 */
export function SunriseHeader({ right, children }: { right?: ReactNode; children?: ReactNode }) {
  ...
  return (
    <LinearGradient
      ...
      style={{ paddingTop: insets.top + 8, paddingHorizontal: spacing.lg, paddingBottom: children ? spacing.md : 14 }}
    >
